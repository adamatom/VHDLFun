...
xst -ifn xst.scr
move baud_clock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\baud_clock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc baud_clock_exdes.ucf baud_clock_exdes

echo 'Running map'
map -timing -pr b baud_clock_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm baud_clock_exdes -w routed.ncd routed.vhd
cd ..
