...
xst -ifn xst.scr
move TwentyMHClock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\TwentyMHClock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc TwentyMHClock_exdes.ucf TwentyMHClock_exdes

echo 'Running map'
map -timing -pr b TwentyMHClock_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm TwentyMHClock_exdes -w routed.ncd routed.vhd
cd ..
